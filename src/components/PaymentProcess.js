...
const tokenPHP = "http://localhost:8888/opencart-3.0.3.1/upload/apiToken.php";
const apiAddress = "http://localhost:8888/opencart-3.0.3.1/upload/index.php?route=/api/shipping/token&api_token=";
...
const url = "http://localhost:8888/opencart-3.0.3.1/upload/index.php?route=api/customer&api_token=" + api_token;
const method = "POST";
...
return  fetch("http://localhost:8888/opencart-3.0.3.1/upload/addNewCustomer.php", { method, body })
.then(res => res.json())
.then(data => alert(JSON.stringify(data, null, "\t")));
/* .then(promise => 
 //console.log("anymessage"+this.state.promise
...
fetch("http://localhost:8888/opencart-3.0.3.1/upload/addToCart.php", { method, body })
.then(res => res.json())
.then(data => alert(JSON.stringify(data, null, "\t")));
}
////////////////////////////////////////
...
///////////
const paymentMethodsAddress = "http://localhost:8888/opencart-3.0.3.1/upload/index.php?route=api/payment/methods&api_token=";
const paymentMethodsCurl = "http://localhost:8888/opencart-3.0.3.1/upload/addPaymentMethods.php";
if (obj !== undefined){
...
fetch("http://localhost:8888/opencart-3.0.3.1/upload/AddNewShipAddress.php", { method, body })
.then(res => res.json())
.then(data => alert(JSON.stringify(data, null, "\t")));
}
...
const shippingMethodAddress = "http://localhost:8888/opencart-3.0.3.1/upload/index.php?route=api/shipping/method&api_token=";
const shippingMethodCurl = "http://localhost:8888/opencart-3.0.3.1/upload/addShippingMethod.php";
...
const checkoutGuest = "http://localhost:8888/opencart-3.0.3.1/upload/index.php?route=checkout/guest";
const checkoutGuestSave = "http://localhost:8888/opencart-3.0.3.1/upload/index.php?route=checkout/guest/save&api_token=99bfd11c4b3cc5130712995760";
const shippingMethodsAddress = "http://localhost:8888/opencart-3.0.3.1/upload/index.php?route=api/shipping/methods&api_token=";
const shippingMethodsCurl = "http://localhost:8888/opencart-3.0.3.1/upload/addShippingMethods.php";
const shippingObj = {shipping_method:"flat.flat"};
const shippingMethodAddress = "http://localhost:8888/opencart-3.0.3.1/upload/index.php?route=api/shipping/method&api_token=";
const shippingMethodCurl = "http://localhost:8888/opencart-3.0.3.1/upload/addShippingMethod.php";
//
const paymentAddressAddress = "http://localhost:8888/opencart-3.0.3.1/upload/index.php?route=api/payment/address&api_token=";
const paymentAddressCurl = "http://localhost:8888/opencart-3.0.3.1/upload/addPaymentAddress.php";
//
const paymentMethodsAddress = "http://localhost:8888/opencart-3.0.3.1/upload/index.php?route=api/payment/methods&api_token=";
const paymentMethodsCurl = "http://localhost:8888/opencart-3.0.3.1/upload/addPaymentMethods.php";
//
const paymentMethodAddress = "http://localhost:8888/opencart-3.0.3.1/upload/index.php?route=api/payment/method&api_token=";
const paymentMethodCurl = "http://localhost:8888/opencart-3.0.3.1/upload/addPaymentMethod.php";
const paymentObj = {payment_method:"pp_standard"};
//order
const orderCurl = "http://localhost:8888/opencart-3.0.3.1/upload/addOrder.php";
const orderAddress = "http://localhost:8888/opencart-3.0.3.1/upload/index.php?route=api/order/add&api_token=";
//redirect
const redirectUrl = "http://localhost:8888/opencart-3.0.3.1/upload/addOrder.php";
const redirectAddress = "http://localhost:8888/opencart-3.0.3.1/upload/index.php?route=api/order/pp_Order&api_token=";
// catagory request
const categoryAddress = "http://localhost:8888/opencart-3.0.3.1/upload/index.php?route=product/category";
const categoryId = "59";
const categoryCurl = "http://localhost:8888/opencart-3.0.3.1/upload/getCatagory.php";
//
const shippingAddressAddress = "http://localhost:8888/opencart-3.0.3.1/upload/index.php?route=api/shipping/address&api_token=";
const shippingAddressCurl = "http://localhost:8888/opencart-3.0.3.1/upload/AddNewShipAddress.php";
//
let count = 0;
const form = "false";
