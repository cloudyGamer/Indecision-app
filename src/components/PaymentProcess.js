...
const url = "https://www.testonly.forevermecosmetics.ie/opencart-3.0.3.1/upload/index.php?route=api/customer&api_token=" + api_token;
const method = "POST";
...
return  fetch("https://www.testonly.forevermecosmetics.ie/opencart-3.0.3.1/upload/addNewCustomer.php", { method, body })
.then(res => res.json())
.then(data => alert(JSON.stringify(data, null, "\t")));
/* .then(promise => 
 //console.log("anymessage"+this.state.promise
...
///////////
//https://www.testonly.forevermecosmetics.ie/opencart-3.0.3.1/upload/index.php?route=/api/shipping/methods&api_token=bee6b1b9f22fd417ede11a687c
//https://www.testonly.forevermecosmetics.ie/opencart-3.0.3.1/upload/index.php?route=/api/shipping/methods&api_token=549f50ac71333331778b73e7ad
else {
body.append("url", url);
console.log("https://www.testonly.forevermecosmetics.ie/opencart-3.0.3.1/upload/index.php?route=/api/shipping/methods&api_token=" + api_token);
...
///////////
const paymentMethodsAddress = "https://www.testonly.forevermecosmetics.ie/opencart-3.0.3.1/upload/index.php?route=api/payment/methods&api_token=";
const paymentMethodsCurl = "https://www.testonly.forevermecosmetics.ie/opencart-3.0.3.1/upload/addPaymentMethods.php";
if (obj !== undefined){
...
fetch("https://www.testonly.forevermecosmetics.ie/opencart-3.0.3.1/upload/AddNewShipAddress.php", { method, body })
.then(res => res.json())
.then(data => alert(JSON.stringify(data, null, "\t")));
}
...
const shippingMethodAddress = "https://www.testonly.forevermecosmetics.ie/opencart-3.0.3.1/upload/index.php?route=api/shipping/method&api_token=";
const shippingMethodCurl = "https://www.testonly.forevermecosmetics.ie/opencart-3.0.3.1/upload/addShippingMethod.php";
...
const checkoutGuest = "https://www.testonly.forevermecosmetics.ie/opencart-3.0.3.1/upload/index.php?route=checkout/guest";
const checkoutGuestSave = "https://www.testonly.forevermecosmetics.ie/opencart-3.0.3.1/upload/index.php?route=checkout/guest/save&api_token=99bfd11c4b3cc5130712995760";
const shippingMethodsAddress = "https://www.testonly.forevermecosmetics.ie/opencart-3.0.3.1/upload/index.php?route=api/shipping/methods&api_token=";
const shippingMethodsCurl = "https://www.testonly.forevermecosmetics.ie/opencart-3.0.3.1/upload/addShippingMethods.php";
const shippingObj = {shipping_method:"flat.flat"};
const shippingMethodAddress = "https://www.testonly.forevermecosmetics.ie/opencart-3.0.3.1/upload/index.php?route=api/shipping/method&api_token=";
const shippingMethodCurl = "https://www.testonly.forevermecosmetics.ie/opencart-3.0.3.1/upload/addShippingMethod.php";
//
const paymentAddressAddress = "https://www.testonly.forevermecosmetics.ie/opencart-3.0.3.1/upload/index.php?route=api/payment/address&api_token=";
const paymentAddressCurl = "https://www.testonly.forevermecosmetics.ie/opencart-3.0.3.1/upload/addPaymentAddress.php";
//
const paymentMethodsAddress = "https://www.testonly.forevermecosmetics.ie/opencart-3.0.3.1/upload/index.php?route=api/payment/methods&api_token=";
const paymentMethodsCurl = "https://www.testonly.forevermecosmetics.ie/opencart-3.0.3.1/upload/addPaymentMethods.php";
//
const paymentMethodAddress = "https://www.testonly.forevermecosmetics.ie/opencart-3.0.3.1/upload/index.php?route=api/payment/method&api_token=";
const paymentMethodCurl = "https://www.testonly.forevermecosmetics.ie/opencart-3.0.3.1/upload/addPaymentMethod.php";
const paymentObj = {payment_method:"pp_standard"};
//order
const orderCurl = "https://www.testonly.forevermecosmetics.ie/opencart-3.0.3.1/upload/addOrder.php";
const orderAddress = "https://www.testonly.forevermecosmetics.ie/opencart-3.0.3.1/upload/index.php?route=api/order/add&api_token=";
//redirect
const redirectUrl = "https://www.testonly.forevermecosmetics.ie/opencart-3.0.3.1/upload/addOrder.php";
const redirectAddress = "https://www.testonly.forevermecosmetics.ie/opencart-3.0.3.1/upload/index.php?route=api/order/pp_Order&api_token=";
// catagory request
const categoryAddress = "https://www.testonly.forevermecosmetics.ie/opencart-3.0.3.1/upload/index.php?route=product/category";
const categoryId = "59";
const categoryCurl = "https://www.testonly.forevermecosmetics.ie/opencart-3.0.3.1/upload/getCatagory.php";
//
const shippingAddressAddress = "https://www.testonly.forevermecosmetics.ie/opencart-3.0.3.1/upload/index.php?route=api/shipping/address&api_token=";
const shippingAddressCurl = "https://www.testonly.forevermecosmetics.ie/opencart-3.0.3.1/upload/AddNewShipAddress.php";
//
let count = 0;
const form = "false";
