...
const tokenPHP = "www.testonly.forevermecosmetics.ie/opencart-3.0.3.1/upload/apiToken.php";
const apiAddress = "www.testonly.forevermecosmetics.ie/opencart-3.0.3.1/upload/index.php?route=/api/shipping/token&api_token=";
...
const url = "www.testonly.forevermecosmetics.ie/opencart-3.0.3.1/upload/index.php?route=api/customer&api_token=" + api_token;
const method = "POST";
...
return  fetch("www.testonly.forevermecosmetics.ie/opencart-3.0.3.1/upload/addNewCustomer.php", { method, body })
.then(res => res.json())
.then(data => alert(JSON.stringify(data, null, "\t")));
/* .then(promise => 
 //console.log("anymessage"+this.state.promise
...
fetch("www.testonly.forevermecosmetics.ie/opencart-3.0.3.1/upload/addToCart.php", { method, body })
.then(res => res.json())
.then(data => alert(JSON.stringify(data, null, "\t")));
}
////////////////////////////////////////
...
///////////
//www.testonly.forevermecosmetics.ie/opencart-3.0.3.1/upload/index.php?route=/api/shipping/methods&api_token=bee6b1b9f22fd417ede11a687c
//www.testonly.forevermecosmetics.ie/opencart-3.0.3.1/upload/index.php?route=/api/shipping/methods&api_token=549f50ac71333331778b73e7ad
else {
body.append("url", url);
console.log("www.testonly.forevermecosmetics.ie/opencart-3.0.3.1/upload/index.php?route=/api/shipping/methods&api_token=" + api_token);
...
///////////
const paymentMethodsAddress = "www.testonly.forevermecosmetics.ie/opencart-3.0.3.1/upload/index.php?route=api/payment/methods&api_token=";
const paymentMethodsCurl = "www.testonly.forevermecosmetics.ie/opencart-3.0.3.1/upload/addPaymentMethods.php";
if (obj !== undefined){
...
fetch("www.testonly.forevermecosmetics.ie/opencart-3.0.3.1/upload/AddNewShipAddress.php", { method, body })
.then(res => res.json())
.then(data => alert(JSON.stringify(data, null, "\t")));
}
...
const shippingMethodAddress = "www.testonly.forevermecosmetics.ie/opencart-3.0.3.1/upload/index.php?route=api/shipping/method&api_token=";
const shippingMethodCurl = "www.testonly.forevermecosmetics.ie/opencart-3.0.3.1/upload/addShippingMethod.php";
...
const checkoutGuest = "www.testonly.forevermecosmetics.ie/opencart-3.0.3.1/upload/index.php?route=checkout/guest";
const checkoutGuestSave = "www.testonly.forevermecosmetics.ie/opencart-3.0.3.1/upload/index.php?route=checkout/guest/save&api_token=99bfd11c4b3cc5130712995760";
const shippingMethodsAddress = "www.testonly.forevermecosmetics.ie/opencart-3.0.3.1/upload/index.php?route=api/shipping/methods&api_token=";
const shippingMethodsCurl = "www.testonly.forevermecosmetics.ie/opencart-3.0.3.1/upload/addShippingMethods.php";
const shippingObj = {shipping_method:"flat.flat"};
const shippingMethodAddress = "www.testonly.forevermecosmetics.ie/opencart-3.0.3.1/upload/index.php?route=api/shipping/method&api_token=";
const shippingMethodCurl = "www.testonly.forevermecosmetics.ie/opencart-3.0.3.1/upload/addShippingMethod.php";
//
const paymentAddressAddress = "www.testonly.forevermecosmetics.ie/opencart-3.0.3.1/upload/index.php?route=api/payment/address&api_token=";
const paymentAddressCurl = "www.testonly.forevermecosmetics.ie/opencart-3.0.3.1/upload/addPaymentAddress.php";
//
const paymentMethodsAddress = "www.testonly.forevermecosmetics.ie/opencart-3.0.3.1/upload/index.php?route=api/payment/methods&api_token=";
const paymentMethodsCurl = "www.testonly.forevermecosmetics.ie/opencart-3.0.3.1/upload/addPaymentMethods.php";
//
const paymentMethodAddress = "www.testonly.forevermecosmetics.ie/opencart-3.0.3.1/upload/index.php?route=api/payment/method&api_token=";
const paymentMethodCurl = "www.testonly.forevermecosmetics.ie/opencart-3.0.3.1/upload/addPaymentMethod.php";
const paymentObj = {payment_method:"pp_standard"};
//order
const orderCurl = "www.testonly.forevermecosmetics.ie/opencart-3.0.3.1/upload/addOrder.php";
const orderAddress = "www.testonly.forevermecosmetics.ie/opencart-3.0.3.1/upload/index.php?route=api/order/add&api_token=";
//redirect
const redirectUrl = "www.testonly.forevermecosmetics.ie/opencart-3.0.3.1/upload/addOrder.php";
const redirectAddress = "www.testonly.forevermecosmetics.ie/opencart-3.0.3.1/upload/index.php?route=api/order/pp_Order&api_token=";
// catagory request
const categoryAddress = "www.testonly.forevermecosmetics.ie/opencart-3.0.3.1/upload/index.php?route=product/category";
const categoryId = "59";
const categoryCurl = "www.testonly.forevermecosmetics.ie/opencart-3.0.3.1/upload/getCatagory.php";
//
const shippingAddressAddress = "www.testonly.forevermecosmetics.ie/opencart-3.0.3.1/upload/index.php?route=api/shipping/address&api_token=";
const shippingAddressCurl = "www.testonly.forevermecosmetics.ie/opencart-3.0.3.1/upload/AddNewShipAddress.php";
//
let count = 0;
const form = "false";
