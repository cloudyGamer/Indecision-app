...
async componentDidMount(){
     ...
     {//call google sheets
     //const webScraperAddress = "https://testonly.forevermecosmetics.ie/quickstart.php";
     //call shopify
     //const shopifyAPI = "https://bubbles-and-co.myshopify.com/admin/api/2019-04/products.json";
     }
     //////////////////////////////////////// feat prod 1
     const productAddress = "https://testonly.forevermecosmetics.ie/index.php?route=product/product&product_id=";
     const productId = "50";
...
featuredProductLoader =  async (iteration,uniqueMessage,keyName) => {
     ...
     const productAddress = "https://testonly.forevermecosmetics.ie/index.php?route=product/product&product_id="+iteration;
