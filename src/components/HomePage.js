...
async componentDidMount(){
     ...
     {//call google sheets
     //const webScraperAddress = "https://pauldowlingportfolio.com/opencart-3.0.3.1/upload/quickstart.php";
     //call shopify
     //const shopifyAPI = "https://bubbles-and-co.myshopify.com/admin/api/2019-04/products.json";
     }
     //////////////////////////////////////// feat prod 1
     const productAddress = "https://pauldowlingportfolio.com/opencart-3.0.3.1/upload/index.php?route=product/product&product_id=";
     const productId = "50";
...
featuredProductLoader =  async (iteration,uniqueMessage,keyName) => {
     ...
     const productAddress = "https://pauldowlingportfolio.com/opencart-3.0.3.1/upload/index.php?route=product/product&product_id="+iteration;
...
<div>
  ...
  <BigImage 
     ...
     articleLink = {"wwwhelloterrilowe.com/2017/02/5-reasons-to-choose-bomb-cosmetics.html"}/>
