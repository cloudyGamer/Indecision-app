...
/////////////////////////////////////////////////////////// main component
   ...
   testVal: "basketObj: testValueBilly",
     category: "Bath Bombs",
     fetchUrl: "https://www.testonly.forevermecosmetics.ie/opencart-3.0.3.1/upload/APINoBody.php",
     address: "https://www.testonly.forevermecosmetics.ie/opencart-3.0.3.1/upload/index.php?route=api/cart/products&api_token=",
   ...
   testVal: "testVal",
     ...
     payLoad: {
      fetchUrl: "https://www.testonly.forevermecosmetics.ie/opencart-3.0.3.1/upload/getCatagory.php",
      package: {address: "https://www.testonly.forevermecosmetics.ie/opencart-3.0.3.1/upload//index.php?route=api/cart/remove&api_token=",
         searchQuery: {}}},
...
//      }*/
//
     return fetch("https://www.testonly.forevermecosmetics.ie/opencart-3.0.3.1/upload/addToCart.php", {method, body})
...
////////////////////////////////////////
   ...
   console.log("fetchCategory executed with parameter" + data + "from within" + uniqueMessage);
       return window.fetch(`https://www.testonly.forevermecosmetics.ie/opencart-3.0.3.1/upload/index.php?route=product/product/getProductCategory&product_id=` + data, {
     method: 'GET', // or 'PUT' 
...
//////////////////////////////////////// menu click handler
   ...
   console.log("Indec:menuHandleClick called");
     ...
     return  this.noCurlCall("https://www.testonly.forevermecosmetics.ie/opencart-3.0.3.1/upload/index.php?route=product/category/apiCategories", "Indec:CDM", this.categoryObj);
   }
//////////////////////////////////////// APIGenericPostSave
...
//<editor-fold defaultstate="collapsed" desc="lets">
     ...
     let currentObj;
     let slideMenuScroll = "";
     //let availableCategories = this.noCurlCall("https://www.testonly.forevermecosmetics.ie/opencart-3.0.3.1/upload/index.php?route=product/category/apiCategories","Indec:CDM",this.categoryObj);
