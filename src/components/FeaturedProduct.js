...
export default class FeaturedProduct extends React.Component {
     ...
     render() {
        ...
        var productImage = "http://localhost:8888/opencart-3.0.3.1/upload/image/"+this.state1.image;
        var productImage2 = "http://localhost:8888/opencart-3.0.3.1/upload/image/"+this.state2.image;
