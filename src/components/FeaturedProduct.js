...
export default class FeaturedProduct extends React.Component {
     ...
     render() {
        ...
        var productImage = "http://testonly.forevermecosmetics.ie/opencart-3.0.3.1/upload/image/"+this.state1.image;
        var productImage2 = "http://testonly.forevermecosmetics.ie/opencart-3.0.3.1/upload/image/"+this.state2.image;
